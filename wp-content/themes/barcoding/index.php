    ...
    <main class="clear">
      <div class="video-bubble hero halfway-section">
        <div class="compartment">
		  ...
		  <?php $intro = get_field("introduction");?>
      ...
      <ul class="swift-slide product-slide halfway-section">
        <li class="hero product">
          ...
          </div><img src="<?php bloginfo('template_directory'); ?>/assets/images/honeywell.jpg" alt="undefined">
        </li>
        <li class="hero product">
          <div class="compartment">
            <div class="product__details">
      ...
      <div class="halfway-section">
        <ul class="partners">
          ...
          <li class="partners__item"><a href=""><img src="<?php bloginfo('template_directory'); ?>/assets/images/descartes.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php bloginfo('template_directory'); ?>/assets/images/honeywell.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php bloginfo('template_directory'); ?>/assets/images/nicelabel.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php bloginfo('template_directory'); ?>/assets/images/intellitrack.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php bloginfo('template_directory'); ?>/assets/images/zebra.png" alt="undefined"></a></li>
        </ul>
        <div class="bubble bubble--big bubble--white">
          <div class="compartment">
            <div class="blockquote-bubble clear">
                <figure class="shifted-asset shifted-asset--left"><img src="<?php bloginfo('template_directory'); ?>/assets/images/big-circle.jpg" alt="">
