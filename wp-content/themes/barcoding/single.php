          ...
          <div class="main-content">
            <div class="section">
              <div class="compartment">
                ...
                <figure class="shifted-asset shifted-asset--left shifted-asset--outlined"><img src="<?php bloginfo('template_directory'); ?>./assets/images/partner.jpg"></figure>
                ...
                <div class="silk-harmonica silk-harmonica--condensed">
                  ...
                  <article role="tabpanel" class="silk-harmonica__content"> 
                    <figure class="shifted-asset shifted-asset--left"><img src="<?php bloginfo('template_directory'); ?>./assets/images/inkjet.jpg"></figure>
              ...
              <div class="grid grid--40">
                <div class="col-yatterman-4"><img src="<?php bloginfo('template_directory'); ?>./assets/images/printer.jpg" class="full-width titled-image">
                  <h3>Header Lorem Ipsum dolor</h3>
                ...
                <div class="col-yatterman-4"><img src="<?php bloginfo('template_directory'); ?>./assets/images/items.jpg" class="full-width titled-image">
                  <h3>Header Lorem Ipsum dolor</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vitae ligula dolor. Praesent semper ipsum eleifend leo fringilla auctor. Nam</p>
                </div>
                <div class="col-yatterman-4"><img src="<?php bloginfo('template_directory'); ?>./assets/images/items.jpg" class="full-width titled-image">
